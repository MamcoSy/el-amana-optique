...
class UsersController
{
    ...
    public function add()
    {
        ...
        if ( Request::method() == 'POST' ) {
            ...
            History::insert( [
                ...
                'h_action'  =>
                'à ajouter un nouvelle utilisateur sous le nom de ' . request(
                    'first_name'
                ) . ' ' . request( 'last_name' ),
                'h_date'    => date( 'Y-m-d' ),
            ] );
    ...
    public function delete( int $id )
    {
        ...
        History::insert( [
            'h_user_id' => Session::get( 'auth_id' ),
            'h_action'  => 'à supprimer l\'utilisateur ' . $user
                ->u_first_name . ' ' . $user->u_last_name,
            'h_date'    => date( 'Y-m-d' ),
        ] );
    ...
    public function edit( int $id )
    {
        ...
        History::insert( [
            'h_user_id' => Session::get( 'auth_id' ),
            'h_action'  => 'à Modifier l\'utilisateur ' .
